...
export default function ResetPassword() {
  ...
  if (success) {
    return (
      <div className="text-center">
        ...
        <h1 className="font-display font-bold text-2xl text-text-primary">Password reset</h1>
  ...
  return (
    <div>
      <h1 className="font-display font-bold text-2xl md:text-3xl text-text-primary">Set a new password</h1>
